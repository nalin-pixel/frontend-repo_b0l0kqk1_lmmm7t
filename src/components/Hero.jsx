        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-slate-300 text-lg">
              A blazing-fast collaborative canvas with live cursors, global undo/redo, and smooth strokes. Built with WebSockets and the HTML5 Canvas API.
            </p>
            <ul className="mt-6 space-y-2 text-slate-300 text-sm">
              <li>• Brush & eraser with color and width controls</li>
              <li>• Live presence and per-user colors</li>
              <li>• Conflict-safe global history</li>
            </ul>
          ...
          <div className="relative h-80 md:h-[28rem] rounded-xl ring-1 ring-white/10 overflow-hidden">
            <Spline scene="https://prod.spline.design/nx5m6oU4dCjs2XQv/scene.splinecode" style={{ width: '100%', height: '100%' }} />
